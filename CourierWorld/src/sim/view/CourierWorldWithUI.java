...
public class CourierWorldWithUI extends GUIState {
    ...
    public void setupPortrayals() {
        ...
        colorList.add(Color.red);colorList.add(Color.BLUE);colorList.add(Color.green);colorList.add(Color.magenta);colorList.add(Color.yellow);colorList.add(Color.cyan);colorList.add(Color.ORANGE);colorList.add(Color.pink);
        courierWorldPortrayal.setPortrayalForAll(new OvalPortrayal2D(3.0){
